...
class Dehradun : Fragment() {
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val list= arrayListOf(R.drawable.dehra1, R.drawable.dehra2, R.drawable.dehra3)
        val binding= FragmentDehradunBinding.inflate(inflater,container,false)
    ...
    private fun Location() {
        val uri =
            Uri.parse("geo:30.32239029888826, 78.01643423119452")
    ...
    private fun Food() {
        val uri =
            Uri.parse("geo:30.32239029888826, 78.01643423119452?q=restaurants")
        val intent = Intent(Intent.ACTION_VIEW, uri)
        intent.setPackage("com.google.android.apps.maps")
        startActivity(intent)
    }
    ...
    private fun Stay() {
        val uri =
            Uri.parse("geo:30.32239029888826, 78.01643423119452?q=hotels")
        val intent = Intent(Intent.ACTION_VIEW, uri)
        intent.setPackage("com.google.android.apps.maps")
        startActivity(intent)
    }
